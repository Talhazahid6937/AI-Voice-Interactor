...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = AIVoiceInteractorConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(AIVoiceInteractorDbContext context)
    {
        _context = context;
    }
