...
public abstract class AIVoiceInteractorWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static AIVoiceInteractorWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(AIVoiceInteractorWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<AIVoiceInteractorDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<AIVoiceInteractorDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<AIVoiceInteractorDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<AIVoiceInteractorDbContext, Task<T>> func)
    {
        T result;
